    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-4 py-2 rounded-xl bg-amber-400 hover:bg-amber-300 text-neutral-950 font-bold text-xs uppercase tracking-wider transition-all shadow-md flex items-center gap-1.5"
          >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        ...
        >
          ...
          <div className="text-[10px] text-amber-400 font-mono mt-0.5">{formatBDT(counts.totalRevenue)}</div>
        </div>
      ...
      <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-4 flex flex-col md:flex-row gap-3 items-center justify-between">
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full bg-neutral-950 border border-neutral-800 rounded-xl pl-10 pr-4 py-2 text-xs text-neutral-200 placeholder:text-neutral-500 focus:outline-none focus:border-amber-400 transition-colors"
          />
        </div>
        ...
        <div className="w-full md:w-auto shrink-0">
          <select
            ...
            className="w-full md:w-auto bg-neutral-950 border border-neutral-800 text-xs rounded-xl px-3 py-2 text-neutral-200 focus:outline-none focus:border-amber-400"
          >
              ...
              >
                  ...
                  <div className="flex items-center gap-2 sm:gap-3 flex-wrap">
                    ...
                    <div className="flex items-center gap-1.5">
                      ...
                      <select
                        ...
                        className="bg-neutral-950 border border-neutral-700 text-xs font-semibold rounded-lg px-2.5 py-1.5 text-neutral-200 focus:outline-none focus:border-amber-400"
                      >
                    ...
                    {/* Total */}
                    <div className="font-brand font-bold text-base text-amber-400 px-3 py-1 rounded-lg bg-neutral-950 border border-neutral-800">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 p-3.5 rounded-xl bg-neutral-950/80 border border-neutral-800/80 text-xs">
                  ...
                  <div>
                    ...
                    <div className="font-medium text-amber-300 mt-1 flex items-center gap-1">
                  ...
                  <div>
                    ...
                    <div className="text-neutral-300">
                      Method: <strong className="text-amber-300">{order.paymentMethod}</strong>
                    </div>
                    {order.courier && (
                    ...
                    {order.notes && (
                      <div className="text-[11px] text-amber-400/80 mt-1 italic line-clamp-2">
                        "{order.notes}"
                      </div>
                    )}
                  </div>
                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className="text-[11px] text-neutral-400 mt-0.5 flex items-center gap-2">
                            <span>
                              Size: <strong className="text-amber-300">{item.size}</strong>
                            </span>
                            <span>•</span>
            ...
            <form onSubmit={handleCreateManualOrder} className="space-y-3 text-xs">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-neutral-950 border border-neutral-800 rounded-lg px-3 py-2 text-neutral-200 focus:outline-none focus:border-amber-400"
                  />
                </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full bg-neutral-950 border border-neutral-800 rounded-lg px-3 py-2 text-neutral-200 focus:outline-none focus:border-amber-400 resize-none"
                />
              </div>
              ...
              <div className="flex justify-end gap-2 pt-3 border-t border-neutral-800">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 rounded-xl bg-amber-400 hover:bg-amber-300 text-neutral-950 font-bold uppercase tracking-wider"
                >
                  Save & Log Order
                </button>
              </div>
